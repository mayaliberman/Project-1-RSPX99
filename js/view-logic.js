...
function getPlayerMove(player, round) {
  ...
  if (player === 'Player One') {
    switch (round) {
      case 1:
        move.type = P1MovesTypes[0];
        move.value = P1MovesValues[0];
        break;
      case 2:
        move.type = P1MovesTypes[1];
        move.value = P1MovesValues[1];
        break;
      case 3:
        move.type = P1MovesTypes[2];
        move.value = P1MovesValues[2];
        break;
    }
  } else {
    switch (round) {
      case 1:
        move.type = P2MovesTypes[0];
        move.value = P2MovesValues[0];
        break;
      case 2:
        move.type = P2MovesTypes[1];
        move.value =  P2MovesValues[1];
        break;
      case 3:
        move.type = P2MovesTypes[2];
        move.value =  P2MovesValues[2];
        break;
    }
  }
  return move;
